...
export default function SearchPage() {
  return (
    <div className="space-y-6 max-w-2xl mx-auto text-center py-12">
      ...
      <h1 className="text-2xl font-bold tracking-tight">{vi.nav.search}</h1>
      <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md mx-auto">
        Tính năng tìm kiếm học phần và từ vựng nhanh chóng sẽ sẵn sàng trong các bản cập nhật tiếp theo.
      </p>
      <div className="pt-4">
        <Link
          href="/"
